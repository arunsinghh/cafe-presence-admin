...
/*
 * Prisma returns permissions as nested objects:
 *
 * {
 *   id: 1,
 *   employeeId: 2,
...
const PERMISSION_GROUPS: {
...

  {
    ...
    permissions: [
      ...
      {
        value: "VOUCHER_CREATE",
        label: "Create Vouchers"
      },
      {
        value: "VOUCHER_MANAGE",
...

  {
    ...
    permissions: [
      ...
      {
        value: "PRESENCE_VERIFY",
        label: "Verify Presence"
      },
      {
        value: "PRESENCE_MANAGE",
...

  {
    ...
    permissions: [
      {
        value: "CAFE_CONFIG_VIEW",
        label: "View Cafe Configuration"
      },
      {
        value: "CAFE_CONFIG_MANAGE",
        label: "Manage Cafe Configuration"
      }
    ]
  },
...
export default function Employees() {
  ...
  const openPermissions =
    (
      ...
      /*
       * Convert Prisma nested permission
       * objects into Permission[].
       *
       * Also supports a plain string array
       * for compatibility.
       */
        ...
        <div className="space-y-5">
          <div className="rounded-input border border-border bg-background p-3">
            ...
            <p className="mt-1 text-xs text-text-secondary">
              Select which features this
              employee can access. Changes
